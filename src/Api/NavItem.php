 ...
 * Срок подписи задаёт установка и держит его заметно выше срока кэша, с которым
 * пакет поставляется (`identity.cache.services_ttl`); подняв свой срок, продукт
 * обязан убедиться, что запас сохранился. Ссылка, протухшая раньше кэша, даёт
 * битые иконки у всех его пользователей до следующего промаха кэша.
 *
