...
return [
    ...
    'cache' => [
        ...
        /*
         * Срок кэша данных рейла. У него есть **верхняя граница, заданная
         * не здесь**: в кэш попадают уже подписанные ссылки на иконки пунктов,
         * и срок кэша обязан быть заметно меньше срока подписи, который задаёт
         * установка. Ссылка, протухшая раньше кэша, даёт битые иконки у всех
         * пользователей продукта до следующего промаха.
         *
